...
<head>
    ...
    <title>Pengajuan Operasional Dikirim ke Admin</title>
    <style>
        body {
...
<body>
    <div class="email-container">
        <div class="email-header">
            ...
            <p>Dikirim ke Admin untuk Diproses</p>
        </div>
        ...
        <div class="email-body">
            ...
            <div class="workflow-step">
                ...
                <p>Pengajuan ini telah melewati tahap persetujuan dan sekarang sampai di tahap admin untuk diproses lebih lanjut.</p>
            </div>
