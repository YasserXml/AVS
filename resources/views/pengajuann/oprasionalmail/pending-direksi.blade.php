...
<head>
    ...
    <title>Pengajuan Dipending</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            <h1>⏳ Pengajuan Dipending</h1>
        </div>

        <div class="content">
            <div class="alert">
                <div class="alert-title">Pengajuan Dipending</div>
                <p class="alert-text">Pengajuan telah dipending oleh Direksi dan memerlukan tindak lanjut.</p>
            </div>

            <p>Kami ingin menginformasikan bahwa pengajuan telah dipending oleh Direksi dengan detail sebagai
                berikut:</p>
