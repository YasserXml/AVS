    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <p class="font-medium text-gray-900 dark:text-gray-100">{{ \Carbon\Carbon::parse($record->tanggal_pengajuan)->format('d F Y') }}</p>
            </div>
            <div>
                <p class="text-sm text-gray-500 dark:text-gray-400">Tanggal Dibutuhkan</p>
                <p class="font-medium text-gray-900 dark:text-gray-100">{{ \Carbon\Carbon::parse($record->tanggal_dibutuhkan)->format('d F Y') }}</p>
            </div>
            <div>
            ...
            @forelse($detailBarang as $index => $barang)
                <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                    <div class="flex justify-between items-start mb-2">
                        <h4 class="font-medium text-gray-900 dark:text-gray-100">{{ $barang['nama_barang'] ?? 'Nama tidak tersedia' }}</h4>
                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-200">
                ...
                @foreach($uploadedFiles as $file)
                    <div class="flex items-center justify-between p-3 border border-gray-200 dark:border-gray-700 rounded-lg">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <p class="text-sm font-medium text-gray-900 dark:text-gray-100">{{ basename($file) }}</p>
    ...
    @else
        <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
            ...
            <div class="text-center py-8 text-gray-500 dark:text-gray-400">
                ...
                <p>Tidak ada file pendukung yang di-upload.</p>
            </div>
        </div>
    @endif
</div>
