...
return new class extends Migration
{
    ...
    {
        Schema::create('sekretariatfolders', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('parent_id')->nullable()->constrained('sekretariatfolders')->onDelete('cascade');
            $table->index(['model_type', 'model_id']);
            $table->timestamps();
            $table->softDeletes();
            $table->foreignId('kategori_id')->nullable()->constrained('kategorisekretariats')->cascadeOnDelete();
        });
    }
    ...
    {
        Schema::dropIfExists('sekretariatfolders');
    }
};
