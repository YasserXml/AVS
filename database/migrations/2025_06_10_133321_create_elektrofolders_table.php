...
return new class extends Migration
{
    ...
    {
        Schema::create('elektrofolders', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('parent_id')->nullable()->constrained('elektrofolders')->onDelete('cascade');
            $table->index(['model_type', 'model_id']);
            $table->timestamps();
            $table->softDeletes();
            $table->foreignId('kategori_id')->nullable()->constrained('kategorielektros')->cascadeOnDelete();
        });
    }
    ...
    {
        Schema::dropIfExists('elektrofolders');
    }
};
