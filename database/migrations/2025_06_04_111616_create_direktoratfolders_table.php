...
return new class extends Migration
{
    ...
    {
        Schema::create('direktoratfolders', function (Blueprint $table) {
            $table->id();
            ...
            $table->timestamps();
            $table->softDeletes();
            $table->foreignId('kategori_id')->nullable()->constrained('kategoridirektorats')->cascadeOnDelete();
        });
    }
    ...
    {
        Schema::dropIfExists('direktoratfolders');
    }
};
