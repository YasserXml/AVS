...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('divisi3dfolders', function (Blueprint $table) {
            ...
            $table->foreignId('parent_id')->nullable()->constrained('divisi3dfolders')->onDelete('cascade');
            $table->index(['model_type', 'model_id']);
            $table->timestamps();
            $table->softDeletes();
            $table->foreignId('kategori_id')->nullable()->constrained('kategori3ds')->cascadeOnDelete();
        });
    }
