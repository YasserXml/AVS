...
return new class extends Migration
{
    ...
    {
        Schema::create('rndfolders', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('parent_id')->nullable()->constrained('rndfolders')->onDelete('cascade');
            $table->index(['model_type', 'model_id']);
            $table->timestamps();
            $table->softDeletes();
            $table->foreignId('kategori_id')->nullable()->constrained('kategorirnds')->cascadeOnDelete();
        });
    }
    ...
    {
        Schema::dropIfExists('rndfolders');
    }
};
