...
return new class extends Migration
{
    ...
    {
        Schema::create('mekanikfolders', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('parent_id')->nullable()->constrained('mekanikfolders')->onDelete('cascade');
            $table->index(['model_type', 'model_id']);
            $table->timestamps();
            $table->softDeletes();
            $table->foreignId('kategori_id')->nullable()->constrained('kategorimekaniks')->cascadeOnDelete();
        });
    }
    ...
    {
        Schema::dropIfExists('mekanikfolders');
    }
};
