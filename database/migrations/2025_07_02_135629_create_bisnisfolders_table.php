...
return new class extends Migration
{
    ...
    {
        Schema::create('bisnisfolders', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('parent_id')->nullable()->constrained('bisnisfolders')->onDelete('cascade');
            $table->index(['model_type', 'model_id']);
            $table->timestamps();
            $table->softDeletes();
            $table->foreignId('kategori_id')->nullable()->constrained('kategoribisnis')->cascadeOnDelete();
        });
    }
    ...
    {
        Schema::dropIfExists('bisnisfolders');
    }
};
