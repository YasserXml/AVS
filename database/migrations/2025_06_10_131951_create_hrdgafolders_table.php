...
return new class extends Migration
{
    ...
    {
        Schema::create('hrdgafolders', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('parent_id')->nullable()->constrained('hrdgafolders')->onDelete('cascade');
            $table->index(['model_type', 'model_id']);
            $table->timestamps();
            $table->softDeletes();
            $table->foreignId('kategori_id')->nullable()->constrained('kategorihrdgas')->cascadeOnDelete();
        });
    }
    ...
    {
        Schema::dropIfExists('hrdgafolders');
    }
};
