...
return new class extends Migration
{
    ...
    {
        Schema::create('pmofolders', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('parent_id')->nullable()->constrained('pmofolders')->onDelete('cascade');
            $table->index(['model_type', 'model_id']);
            $table->timestamps();
            $table->softDeletes();
            $table->foreignId('kategori_id')->nullable()->constrained('kategoripmos')->cascadeOnDelete();
        });
    }
    ...
    {
        Schema::dropIfExists('pmofolders');
    }
};
