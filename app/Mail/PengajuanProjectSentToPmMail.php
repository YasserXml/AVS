...
class PengajuanProjectSentToPmMail extends Mailable
{
    ...
    {
        return new Envelope(
            subject: 'Pengajuan Project Baru ',
        );
    }
    ...
    {
        return new Content(
            view: 'pengajuann.projectmail.sent-to-pm',
            with: [
                'pengajuan' => $this->pengajuan,
                'pengaju' => $this->pengajuan->user,
                'project' => $this->pengajuan->nameproject,
                'projectManager' => $this->pengajuan->nameproject->user ?? null,
