...
class Kategorihrdga extends Model
{
   use HasFactory, SoftDeletes;
    ...
    public function hrdgafolder()
    {
        return $this->hasMany(Hrdgafolder::class, 'kategori_id');
    }
