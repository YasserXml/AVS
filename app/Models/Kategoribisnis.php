...
class Kategoribisnis extends Model
{
    ...
    public function bisnisfolder()
    {
        return $this->hasMany(Bisnisfolder::class, 'kategori_id');
    }
