...
class Sekretariatmedia extends Model implements HasMedia
{
    use InteractsWithMedia;

    protected $table = 'sekretariatmedia';
    ...
    {
        return $this->belongsTo(Sekretariatfolder::class, 'model_id')
    ...
    public function getUrlAttribute(): string
    {
        ...
        if ($this->disk === 'sekretariat_media') {
            return asset('storage/sekretariat/' . $this->file_name);
        }
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            if (empty($model->model_type)) {
                $model->model_type = Sekretariatfolder::class;
            }
    ...
    {
        return $query->where('model_type', Sekretariatfolder::class)
            ->where('model_id', $folderId);
    }
    ...
    public function canBeAccessedBy(?int $userId = null): bool
    {
        ...
        if ($this->model_type === Sekretariatfolder::class && $this->folder) {
