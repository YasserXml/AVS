...
class Keuanganfolder extends Model implements HasMedia
{
    ...
    public function keuanganmedia()
    {
        return $this->hasMany(Keuanganmedia::class, 'model_id')
        ->where('model_type', self::class);
    }
    
    public function uangmedia()
    {
        return $this->keuanganmedia();
    }
    
    public function parent()
    {
        return $this->belongsTo(Keuanganfolder::class, 'parent_id');
    }
    
    public function children()
    {
        return $this->hasMany(Keuanganfolder::class, 'parent_id');
    }
    ...
    public function getAllMedia()
    {
        ...
        $media = collect($this->keuanganmedia);
    ...
    public function deleteRecursively()
    {
        ...
        foreach ($this->keuanganmedia as $mediaItem) {
    ...
    {
        return $this->keuanganmedia()->count() + $this->subfolders()->count();
    }
    ...
    public function getDefaultIcon(): string
    {
        ...
        $mediaCount = $this->uangmedia()->count();
