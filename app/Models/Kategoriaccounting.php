...
class Kategoriaccounting extends Model
{
   use HasFactory, SoftDeletes;
    ...
    public function accountingfolder()
    {
        return $this->hasMany(Accountingfolder::class, 'kategori_id');
    }
