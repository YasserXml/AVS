...
class Pmomedia extends Model implements HasMedia
{
    use InteractsWithMedia, SoftDeletes;

    protected $table = 'pmomedia';
    ...
    {
        return $this->belongsTo(Pmofolder::class, 'model_id')
    ...
    public function getUrlAttribute(): string
    {
        ...
        if ($this->disk === 'pmo_media') {
            return asset('storage/pmo/' . $this->file_name);
        }
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            if (empty($model->model_type)) {
                $model->model_type = Pmofolder::class;
            }
    ...
    {
        return $query->where('model_type', Pmofolder::class)
            ->where('model_id', $folderId);
    }
    ...
    public function canBeAccessedBy(?int $userId = null): bool
    {
        ...
        if ($this->model_type === Pmofolder::class && $this->folder) {
