...
class Mekanikmedia extends Model implements HasMedia
{
    use InteractsWithMedia, SoftDeletes;

    protected $table = 'mekanikmedia';
    ...
    {
        return $this->belongsTo(Mekanikfolder::class, 'model_id')
    ...
    public function getUrlAttribute(): string
    {
        ...
        if ($this->disk === 'mekanik_media') {
            return asset('storage/mekanik/' . $this->file_name);
        }
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            if (empty($model->model_type)) {
                $model->model_type = Mekanikfolder::class;
            }
    ...
    {
        return $query->where('model_type', Mekanikfolder::class)
            ->where('model_id', $folderId);
    }
    ...
    public function canBeAccessedBy(?int $userId = null): bool
    {
        ...
        if ($this->model_type === Mekanikfolder::class && $this->folder) {
