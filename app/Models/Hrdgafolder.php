...
class Hrdgafolder extends Model implements HasMedia
{
    ...
    {
        return $this->belongsTo(Kategorihrdga::class, 'kategori_id');
    }
    ...
    public function deleteRecursively()
    {
        ...
        foreach ($this->hrdgamedia as $mediaItem) {
    ...
    {
        return $this->hrdgamedia()->count() + $this->subfolders()->count();
    }
    ...
    public function getDefaultIcon(): string
    {
        ...
        $mediaCount = $this->hrdmedia()->count();
