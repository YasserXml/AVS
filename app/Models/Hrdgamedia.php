...
class Hrdgamedia extends Model implements HasMedia
{
    use InteractsWithMedia, SoftDeletes;

    protected $table = 'hrdgamedia';
    ...
    {
        return $this->belongsTo(Hrdgafolder::class, 'model_id')
    ...
    public function getUrlAttribute(): string
    {
        ...
        if ($this->disk === 'hrd-ga_media') {
            return asset('storage/hrd-ga/' . $this->file_name);
        }
    ...
    public function getPublicUrl(): string
    {
        try {
            ...
            if ($this->disk === 'local') {
                ...
                return asset('storage/hrdga/' . $this->file_name);
            }
    ...
    public function scopeFolder($query, $folderId = null)
    {
        ...
        if ($folderId) {
            $query->where('model_type', Hrdgafolder::class)
    ...
    {
        return $query->where('model_type', Hrdgafolder::class)
            ->where('model_id', $folderId);
    }
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            if (empty($model->model_type)) {
                $model->model_type = Hrdgafolder::class;
            }
    ...
    public function canBeAccessedBy(?int $userId = null): bool
    {
        ...
        if ($this->model_type === Hrdgafolder::class && $this->folder) {
