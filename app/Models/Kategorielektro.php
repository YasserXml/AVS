...
class Kategorielektro extends Model
{
   use HasFactory, SoftDeletes;
    ...
    public function elektrofolder()
    {
        return $this->hasMany(Elektrofolder::class, 'kategori_id');
    }
