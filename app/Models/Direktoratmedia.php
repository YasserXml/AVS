...
class Direktoratmedia extends Model implements HasMedia
{
    use InteractsWithMedia;

    protected $table = 'direktoratmedia';
    ...
    {
        return $this->belongsTo(Direktoratfolder::class, 'model_id')
    ...
    public function getUrlAttribute(): string
    {
        ...
        if ($this->disk === 'direktorat_media') {
            return asset('storage/direktorat/' . $this->file_name);
        }
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            if (empty($model->model_type)) {
                $model->model_type = Direktoratfolder::class;
            }
    ...
    {
        return $query->where('model_type', Direktoratfolder::class)
            ->where('model_id', $folderId);
    }
    ...
    public function canBeAccessedBy(?int $userId = null): bool
    {
        ...
        if ($this->model_type === Direktoratfolder::class && $this->folder) {
