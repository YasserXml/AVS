...
class Kategorikeuangan extends Model
{
   ...
   public function keuanganfolder()
   {
      return $this->hasMany(Keuanganfolder::class, 'kategori_id');
   }
