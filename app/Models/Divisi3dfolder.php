...
class Divisi3dfolder extends Model implements HasMedia
{
    ...
    public function div3dmedia()
    {
        return $this->hasMany(Divisi3dmedia::class, 'model_id')
            ->where('model_type', self::class);
    }

    public function divisi3dmedia()
    {
        return $this->div3dmedia();
    }

    public function parent()
    {
        return $this->belongsTo(Divisi3dfolder::class, 'parent_id');
    }

    public function children()
    {
        return $this->hasMany(Divisi3dfolder::class, 'parent_id');
    }

    public function kategori()
    {
        return $this->belongsTo(Kategori3d::class, 'kategori_id');
    }
    ...
    public function deleteRecursively()
    {
        ...
        foreach ($this->div3dmedia as $mediaItem) {
    ...
    {
        return $this->div3dmedia()->count() + $this->subfolders()->count();
    }
    ...
    public function getDefaultIcon(): string
    {
        ...
        $mediaCount = $this->divisi3dmedia()->count();
