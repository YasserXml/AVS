...
class Softwarefolder extends Model implements HasMedia
{
    ...
    public function softwaremedia()
    {
        return $this->hasMany(Softwaremedia::class, 'model_id')
            ->where('model_type', self::class);
    }

    public function softmedia()
    {
        return $this->softwaremedia();
    }

    public function kategori()
    {
        return $this->belongsTo(Kategorisoftware::class, 'kategori_id');
    }
    ...
    {
        return $this->belongsTo(Softwarefolder::class, 'parent_id');
    }

    public function children()
    {
        return $this->hasMany(Softwarefolder::class, 'parent_id');
    }
    ...
    public function getAllMedia()
    {
        ...
        $media = collect($this->softwaremedia);
    ...
    public function deleteRecursively()
    {
        ...
        foreach ($this->softwaremedia as $mediaItem) {
    ...
    {
        return $this->softwaremedia()->count() + $this->subfolders()->count();
    }
    ...
    public function getDefaultIcon(): string
    {
        ...
        $mediaCount = $this->softmedia()->count();
