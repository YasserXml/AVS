...
class Softwaremedia extends Model implements HasMedia
{
    use InteractsWithMedia, SoftDeletes;

    protected $table = 'softwaremedia';
    ...
    {
        return $this->belongsTo(Softwarefolder::class, 'model_id')
            ->where('model_type', Softwarefolder::class);
    }
    ...
    public function getUrlAttribute(): string
    {
        ...
        if ($this->disk === 'game-programming_media') {
            return asset('storage/game-programming/' . $this->file_name);
        }
    ...
    public function getPublicUrl(): string
    {
         try {
            ...
            if ($this->disk === 'local') {
                $targetDisk = 'game-programming_media';
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            if (empty($model->model_type)) {
                $model->model_type = Softwarefolder::class;
            }
            ...
            if (empty($model->disk)) {
                $model->disk = 'game-programming_media';
            }
    ...
    {
        return $query->where('model_type', Softwarefolder::class)
            ->where('model_id', $folderId);
    }
    ...
    public function canBeAccessedBy(?int $userId = null): bool
    {
        ...
        if ($this->model_type === Softwarefolder::class && $this->folder) {
