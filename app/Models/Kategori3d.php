...
class Kategori3d extends Model
{
    ...
    public function divisi3dfolder()
    {
        return $this->hasMany(Divisi3dfolder::class, 'kategori_id');
    }
