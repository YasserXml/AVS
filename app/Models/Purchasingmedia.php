...
class Purchasingmedia extends Model implements HasMedia
{
    use InteractsWithMedia, SoftDeletes;

    protected $table = 'purchasingmedia';
    ...
    {
        return $this->belongsTo(Purchasingfolder::class, 'model_id')
    ...
    public function getUrlAttribute(): string
    {
        ...
        if ($this->disk === 'purchasing_media') {
            return asset('storage/purchasing/' . $this->file_name);
        }
    ...
    public function scopeFolder($query, $folderId = null)
    {
        ...
        if ($folderId) {
            $query->where('model_type', Purchasingfolder::class)
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            if (empty($model->model_type)) {
                $model->model_type = Purchasingfolder::class;
            }
    ...
    {
        return $query->where('model_type', Purchasingfolder::class)
            ->where('model_id', $folderId);
    }
    ...
    public function canBeAccessedBy(?int $userId = null): bool
    {
        ...
        if ($this->model_type === Purchasingfolder::class && $this->folder) {
