...
class Mekanikfolder extends Model implements HasMedia
{
    ...
    {
        return $this->belongsTo(Kategorimekanik::class, 'kategori_id');
    }
    ...
    public function deleteRecursively()
    {
        ...
        foreach ($this->mekanikmedia as $mediaItem) {
    ...
    {
        return $this->mekanikmedia()->count() + $this->subfolders()->count();
    }
    ...
    public function getDefaultIcon(): string
    {
        ...
        $mediaCount = $this->mekamedia()->count();
