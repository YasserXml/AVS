...
class Rndfolder extends Model implements HasMedia
{
    ...
    public function rndmedia()
    {
        return $this->hasMany(Rndmedia::class, 'model_id')
            ->where('model_type', self::class);
    }

    public function rnddmedia()
    {
        return $this->rndmedia();
    }

    public function kategori()
    {
        return $this->belongsTo(Kategorirnd::class, 'kategori_id');
    }
    ...
    {
        return $this->belongsTo(Rndfolder::class, 'parent_id');
    }

    public function children()
    {
        return $this->hasMany(Rndfolder::class, 'parent_id');
    }
    ...
    public function deleteRecursively()
    {
        ...
        foreach ($this->rndmedia as $mediaItem) {
    ...
    {
        return $this->rndmedia()->count() + $this->subfolders()->count();
    }
    ...
    public function getDefaultIcon(): string
    {
        ...
        $mediaCount = $this->rnddmedia()->count();
