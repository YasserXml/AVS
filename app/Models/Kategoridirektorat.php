...
class Kategoridirektorat extends Model
{
    ...
    public function direktoratfolder()
    {
        return $this->hasMany(Direktoratfolder::class, 'kategori_id');
    }
