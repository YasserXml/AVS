...
class Kategorisekretariat extends Model
{
   use HasFactory, SoftDeletes;
    ...
    public function sekretariatfolder()
    {
        return $this->hasMany(Sekretariatfolder::class, 'kategori_id');
    }
