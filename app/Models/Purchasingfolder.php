...
class Purchasingfolder extends Model implements HasMedia
{
    ...
    public function purchasingmedia()
    {
        return $this->hasMany(Purchasingmedia::class, 'model_id')
            ->where('model_type', self::class);
    }

    public function pembelianmedia()
    {
        return $this->purchasingmedia();
    }

    public function kategori()
    {
        return $this->belongsTo(Kategoripurchasing::class, 'kategori_id');
    }
    ...
    {
        return $this->belongsTo(Purchasingfolder::class, 'parent_id');
    }

    public function children()
    {
        return $this->hasMany(Purchasingfolder::class, 'parent_id');
    }
    ...
    public function getAllMedia()
    {
        ...
        $media = collect($this->purchasingmedia);
    ...
    public function deleteRecursively()
    {
        ...
        foreach ($this->purchasingmedia as $mediaItem) {
    ...
    {
        return $this->purchasingmedia()->count() + $this->subfolders()->count();
    }
    ...
    public function getDefaultIcon(): string
    {
        ...
        $mediaCount = $this->pembelianmedia()->count();
