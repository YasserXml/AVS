...
class ListSoftwaremedia extends ListRecords
{
    ...
    public ?Softwarefolder $folder = null;
    ...
    public function createMediaAction()
    {
        return Actions\Action::make('createMedia')
            ...
            ->action(function (array $data) {
                ...
                $folder = Softwarefolder::find($folder_id);

                foreach ($data['files'] as $file) {
                    $media = new Softwaremedia();
                    $media->model_type = Softwarefolder::class;
        ...
        return Actions\Action::make('deleteMedia')
            ...
            ->action(function (array $arguments) {
                try {
                    ...
                    $media = Softwaremedia::find($arguments['record']['id']);
        ...
        return Actions\Action::make('deleteFolder')
            ...
            ->action(function () {
                try {
                    ...
                    $medias = Softwaremedia::where('model_type', Softwarefolder::class)
