...
class RndmediaResource extends Resource
{
    protected static ?string $model = Rndmedia::class;
            ...
            ->modifyQueryUsing(function (Builder $query) {
                ...
                if (request()->has('folder')) {
                    ...
                    if ($folder && $folder->canBeAccessedBy()) {
                        $query->where('model_type', Rndfolder::class)
                ...
                elseif (request()->has('folder_id')) {
                    ...
                    $folder = Rndfolder::find($folderId);
            ...
            ->columns([
                Stack::make([
                    ImageColumn::make('image')
                        ...
                        ->square()
                        ->label('Gambar')
                        ->getStateUsing(function (Rndmedia $record) {
