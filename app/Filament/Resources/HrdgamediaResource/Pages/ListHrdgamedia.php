...
class ListHrdgamedia extends ListRecords
{
    ...
    public ?Hrdgafolder $folder = null;
    public $subfolders = null;

    public function getTitle(): string|Htmlable
    {
        return $this->folder?->full_name_path ?? 'Media Hrdga';
    }
    ...
    public function mount(): void
    {
        ...
        $folder = Hrdgafolder::where('slug', $folderSlug)->first();
        ...
        return Actions\Action::make('backToParent')
            ...
            ->url(function () {
                if ($this->folder->parent_id) {
                    $parentFolder = Hrdgafolder::find($this->folder->parent_id);
                    if ($parentFolder) {
                        return route('filament.admin.resources.arsip.hrdga.folder.index', [
                            'folder' => $parentFolder->slug // Gunakan slug, bukan folder_id
                        ]);
                    }
                }
                return route('filament.admin.resources.arsip.hrdga.index');
            });
    }
    ...
    // Perbaiki method createMediaAction
    public function createMediaAction()
    {
        return Actions\Action::make('createMedia')
            ...
            ->action(function (array $data) {
                ...
                $folder = Hrdgafolder::find($folder_id);

                foreach ($data['files'] as $file) {
                    $media = new Hrdgamedia();
                    $media->model_type = Hrdgafolder::class;
        ...
        return Actions\Action::make('deleteMedia')
            ...
            ->action(function (array $arguments) {
                try {
                    ...
                    $media = Hrdgamedia::find($arguments['record']['id']);
        ...
        return Actions\Action::make('deleteFolder')
            ...
            ->action(function () {
                try {
                    ...
                    $medias = Hrdgamedia::where('model_type', Hrdgafolder::class)
                    ...
                    if ($parentFolder) {
                        ...
                        return redirect()->route('filament.admin.resources.arsip.hrdga.index');
                    }
                } catch (\Exception $e) {
                    Notification::make()
