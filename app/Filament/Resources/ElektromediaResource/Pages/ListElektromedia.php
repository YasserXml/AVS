...
class ListElektromedia extends ListRecords
{
    ...
    public ?Elektrofolder $folder = null;
     ...
     public function createMediaAction()
    {
        return Actions\Action::make('createMedia')
            ...
            ->action(function (array $data) {
                ...
                $folder = Elektrofolder::find($folder_id);

                foreach ($data['files'] as $file) {
                    $media = new Elektromedia();
                    $media->model_type = Elektrofolder::class;
        ...
        return Actions\Action::make('deleteMedia')
            ...
            ->action(function (array $arguments) {
                try {
                    ...
                    $media = Elektromedia::find($arguments['record']['id']);
        ...
        return Actions\Action::make('deleteFolder')
            ...
            ->action(function () {
                try {
                    ...
                    $medias = Elektromedia::where('model_type', Elektrofolder::class)
