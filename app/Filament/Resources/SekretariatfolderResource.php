...
use App\Filament\Resources\SekretariatfolderResource\Pages;
use App\Filament\Resources\SekretariatfolderResource\RelationManagers;
...
{
    protected static ?string $model = Sekretariatfolder::class;
