...
class PurchasingmediaResource extends Resource
{
    protected static ?string $model = Purchasingmedia::class;
    ...
    {
        return 'arsip/purchasing/folder';
    }
        ...
        return $table
            ->modifyQueryUsing(function (Builder $query) {
                ...
                elseif (request()->has('folder_id')) {
                    ...
                    $folder = Purchasingfolder::find($folderId);
            ...
            ->columns([
                Stack::make([
                    ImageColumn::make('image')
                        ...
                        ->square()
                        ->label('Gambar')
                        ->getStateUsing(function (Purchasingmedia $record) {
