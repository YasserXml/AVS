...
class ListBisnismedia extends ListRecords
{
    ...
    public function mount(): void
    {
        ...
        $folder = Bisnisfolder::where('slug', $folderSlug)->first();
        ...
        return Actions\Action::make('backToParent')
            ...
            ->url(function () {
                if ($this->folder->parent_id) {
                    $parentFolder = Bisnisfolder::find($this->folder->parent_id);
                    if ($parentFolder) {
                ...
                return route('filament.admin.resources.arsip.bisnis.index');
            });
    }
    ...
    protected function backToMainAction()
    {
        return Actions\Action::make('backToMain')
            ...
            ->icon('heroicon-o-arrow-left')
            ->color('gray')
            ->url(route('filament.admin.resources.arsip.bisnis.index'));
    }

    protected function getTableQuery(): Builder
    {
        return Bisnismedia::query()
    ...
    public function createMediaAction()
    {
        return Actions\Action::make('createMedia')
            ...
            ->action(function (array $data) {
                ...
                $folder = Bisnisfolder::find($folder_id);

                foreach ($data['files'] as $file) {
                    $media = new Bisnismedia();
                    $media->model_type = Bisnisfolder::class;
                    ...
                    $filePath = storage_path('app/public/bisnis' . $file);
                    $media->mime_type = mime_content_type($filePath);
                    $media->disk = 'bisnis_media';
        ...
        return Actions\Action::make('deleteMedia')
            ...
            ->action(function (array $arguments) {
                try {
                    ...
                    $media = Bisnismedia::find($arguments['record']['id']);
        ...
        return Actions\Action::make('deleteFolder')
            ...
            ->action(function () {
                try {
                    ...
                    $medias = Bisnismedia::where('model_type', Bisnisfolder::class)
