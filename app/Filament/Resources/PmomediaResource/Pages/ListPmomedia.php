...
class ListPmomedia extends ListRecords
{
        ...
        return Actions\Action::make('backToParent')
            ...
            ->url(function () {
                if ($this->folder->parent_id) {
                    $parentFolder = Pmofolder::find($this->folder->parent_id);
                    if ($parentFolder) {
                ...
                return route('filament.admin.resources.arsip.pmo.index');
            });
    }
    ...
    protected function backToMainAction()
    {
        return Actions\Action::make('backToMain')
            ...
            ->icon('heroicon-o-arrow-left')
            ->color('gray')
            ->url(route('filament.admin.resources.arsip.pmo.index'));
    }
    ...
    public function folderAction($folder)
    {
        return Actions\Action::make('openFolder_' . $folder->id)
            ...
            ->action(function () use ($folder) {
                ...
                return redirect()->route('filament.admin.resources.arsip.pmo.folder.index', [
    ...
    public function createMediaAction()
    {
        return Actions\Action::make('createMedia')
            ...
            ->action(function (array $data) {
                ...
                $folder = Pmofolder::find($folder_id);

                foreach ($data['files'] as $file) {
                    $media = new Pmomedia();
                    $media->model_type = Pmofolder::class;
        ...
        return Actions\Action::make('deleteMedia')
            ...
            ->action(function (array $arguments) {
                try {
                    ...
                    $media = Pmomedia::find($arguments['record']['id']);
        ...
        return Actions\Action::make('deleteFolder')
            ...
            ->action(function () {
                try {
                    ...
                    $medias = Pmomedia::where('model_type', Pmofolder::class)
                    ...
                    if ($parentFolder) {
                        ...
                        return redirect()->route('filament.admin.resources.arsip.pmo.index');
                    }
                } catch (\Exception $e) {
                    Notification::make()
